...
@section('contents')
    ...
    <div class="row">
        <div class="contentMain">
            <form class="check-form-change" name="adminForm" method="post" action="{{ route('admin.users.store') }}">
                @csrf
                @method('POST')
                <div class="headeBack">
                    <div class="wrap">
                                ...
                                <div class="formRow-col">
                                    <div class="formGroup">
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" name="company_name" value="{{ old('company_name') }}" type="text" placeholder="例）株式会社ABC">
                                                @error('company_name')
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" type="text" value="{{ old('member_employee') }}" name="member_employee" placeholder="例）50">
                                    ...
                                    <div class="formGroup">
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" type="text" name="phone" value="{{ old('phone') }}" placeholder="例）0312345678">
                                                @error('phone')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror<br><br>
                                            </div>
                                    ...
                                    <div class="formGroup">
                                                ...
                                                <ul class="formGroup-ulCol2">
                                                    <li>
                                                        <div class="inputLabel">
                                                            ...
                                                            <input class="form-control" value="{{ old('surname_kana') }}" name="surname_kana" placeholder="例）山田">
                                                            @error('surname_kana')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            @enderror<br><br>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="inputLabel">
                                                            ...
                                                            <input class="form-control" value="{{ old('name_kana') }}" name="name_kana" placeholder="例）太郎">
                                                            @error('name_kana')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            @enderror<br><br>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="inputLabel">
                                                            ...
                                                            <input value="{{ old('surname_kanji') }}" class="form-control" name="surname_kanji" placeholder="例）ヤマダ">
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="inputLabel">
                                                            <span class="spanLabel">{{trans('admin/user.name_kanji') }}</span>
                                                            <input class="form-control" value="{{ old('name_kanji') }}" name="name_kanji" placeholder="例）タロウ">
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" value="{{ old('department') }}" type="text" name="department" placeholder="例）マーケティング部 部長">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="formRow-col">
                                    <div class="formGroup">
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <div class="postalCode">
                                                    <input class="form-control" value="{{ old('postal_code') }}" type="text" name="postal_code" placeholder="例）1230000">
                                                    <span>〒</span>
                                                    @error('postal_code')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror<br><br>
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" value="{{ old('province_name') }}" name="province_name" type="text" placeholder="東京都">
                                                @error('province_name')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror<br><br>
                                            </div>
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" value="{{ old('district_name') }}" name="district_name" type="text" placeholder="例）渋谷区渋谷１−２−３">
                                                @error('district_name')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror<br><br>
                                            </div>
                                        ...
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" value="{{ old('address') }}" name="address" type="text" placeholder="例）ABCマンション１０２">
                                                @error('address')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror<br><br>
                                            </div>
                                    ...
                                    <div class="formGroup">
                                        <div class="formGroup-input">
                                            ...
                                            <div class="formGroup-control">
                                                <input class="form-control" value="{{ old('email') }}" type="text" name="email" placeholder="例）sample@example.com">
                                                @error('email')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror<br><br>
                                            </div>
